...
CREATE TABLE `lancamentos` (
  ...
  KEY `fk_lancamentos_usuarios_idx` (`usuario_id`),
  ...
  CONSTRAINT `fk_lancamentos_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2016-08-12 11:30:52
